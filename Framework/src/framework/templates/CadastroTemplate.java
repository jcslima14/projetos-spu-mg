...
public abstract class CadastroTemplate extends JInternalFrame {
	...
	private MyButton btnAtualizar = new MyButton("Atualizar", MyUtils.obterIcone("/icons/008-sync.png")) {{ setExclusao(true); }};
	private MyButton btnIncluir = new MyButton("Incluir", MyUtils.obterIcone("/icons/056-add.png")) {{ setExclusao(true); }};
	private MyButton btnExcluir = new MyButton("Excluir", MyUtils.obterIcone("/icons/006-trash.png")) {{ setExclusao(true); }};
	private MyButton btnSalvar = new MyButton("Salvar", MyUtils.obterIcone("/icons/057-check.png")) {{ setEnabled(false); setInclusao(true); setEdicao(true); }};
	private MyButton btnCancelar = new MyButton("Cancelar", MyUtils.obterIcone("/icons/047-cancel-1.png")) {{ setEnabled(false); setInclusao(true); setEdicao(true); }};
