...
import views.cadastro.AssinanteCadastro;
import views.cadastro.AssinanteTipoDespachoCadastro;
import views.cadastro.DestinoCadastro;
import views.cadastro.MunicipioCadastro;
import views.cadastro.MunicipioTipoRespostaCadastro;
import views.cadastro.OrigemCadastro;
import views.cadastro.ParametroCadastro;
import views.cadastro.TipoImovelCadastro;
import views.cadastro.TipoProcessoCadastro;
import views.cadastro.TipoRespostaCadastro;
...
import views.robo.Geocodificacao;
...
public class DespachoSEI extends JFrame {
	...
	public DespachoSEI() {
		...
		JMenuItem sbmGeocodificacao = new JMenuItem("Geocodificação");
		...
		JMenu mnuFerramenta = new JMenu("Ferramentas") {{ add(sbmInclusaoOficioVistoria); add(sbmRestricaoProcesso); add(sbmGeocodificacao); addSeparator(); add(sbmExecucaoScript); }};
		...
		sbmRecepcaoProcessos.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				RecepcaoProcessoSapiens janela = new RecepcaoProcessoSapiens("Recepção de Processos do Sapiens", conexao);
				desktop.add(janela);
				janela.abrirJanela();
			}
		});
		...
		sbmRespostaSapiens.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				RespostaSapiens cargaSEI = new RespostaSapiens("Resposta a Processos no Sapiens", conexao);
		...
		sbmGeocodificacao.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Geocodificacao janela = new Geocodificacao("Geocodificação", conexao);
				desktop.add(janela);
				janela.abrirJanela();
			}
		});
