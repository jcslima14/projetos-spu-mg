...
//		mnuAcoes.add(sbmTesteLayout); 
		...
		sbmTesteLayout.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				TesteLayout testeLayout = new TesteLayout("Carga de Informações do SEI", conexao);
				desktop.add(testeLayout);
				testeLayout.abrirJanela();
			}
		});
